...
export default function Formulario({ realizarTransacao }) {
	...
	return (
		<form className={estilos.formulario} onSubmit={handleSubmit}>
			...
			<select className={estilos.grupo__opcoes} onChange={handleChange} name="transacao" data-testid="select-opcoes">
				<option defaultValue="Selecione um tipo de transação">Selecione um tipo de transação</option>
